...
& $python3 aws-iot-device-sdk-python-v2\samples\mqtt\mqtt5_x509.py --endpoint a3vlu21e6pc561-ats.iot.ap-south-1.amazonaws.com --cert demothing.cert.pem --key demothing.private.key --client_id basicPubSub --topic sdk/test/python --count 0